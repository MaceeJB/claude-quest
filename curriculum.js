...
window.SUPPLEMENTAL = {
  ...
  cards: [
    { heading: "What actually carries over (and what doesn't)", body: "The best part — the <b>know-how you've built is in your head</b>, and that transfers instantly. The <i>customizations</i> you made (your personal preferences file, any custom commands, any <b>Skills</b> you built) are just files, so you can bring those along too. What does <b>not</b> follow you: your logins, your saved sessions, and Claude's auto-memory. None of that syncs automatically; it all stays on the machine where you made it. Treat this as a fresh, clean setup that you season with a few favorite touches." },
    ...
    { heading: "Bringing your customizations to work", body: "On your <b>personal</b> machine, ask Claude to gather your <code>CLAUDE.md</code> and any custom Skills or commands into one folder. Move that folder to your work computer the normal way (OneDrive, email-to-yourself, a USB stick), then on your <b>work</b> machine ask Claude to place them into your <code>.claude</code> folder. No personal <code>CLAUDE.md</code> yet, or want a stronger one? A free tool, <b><a href=\"https://contextportfolio.ai\" target=\"_blank\" rel=\"noopener noreferrer\">contextportfolio.ai</a></b>, interviews you about your role and how you like to work, then generates reusable markdown files you drop straight into your <code>CLAUDE.md</code> so Claude knows you from day one — no more re-explaining yourself each session. Either way, <b>review what you bring over first</b> and trim anything personal or confidential you wouldn't want on a work device." },
